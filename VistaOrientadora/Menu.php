<?php // Comienzo del apartado PHP
session_start(); // Ruta base para enlaces
$base = '/reto4-medicosdelmundo/'; // Ruta de $base
// Acceso para orientadoras (id_rol === 2)
if (!isset($_SESSION['usuario_id']) || !isset($_SESSION['id_rol']) || intval($_SESSION['id_rol']) !== 2) { // Si no hay sesión o el rol no es 2 (orientadora)
	header('Location: /reto4-medicosdelmundo/signin.php'); // Redirige a signin.php
	exit(); 
}
require_once '../conexion.php'; // Conexión a la base de datos
require_once '../clases/Categoria.php'; // Clase Categoria
