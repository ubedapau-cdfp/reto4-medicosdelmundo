...
<header> 
		...
		<?php
			if (intval($_SESSION['id_rol']) === 2) {
				...
				echo '<section class="buttongestion">';
				echo '<button class="logoutbutton">';
				echo '<a href="' . $base . 'Vistadmin/gestion_header.php" class="gestion-header-button"><i class="fa-solid fa-screwdriver-wrench"></i>Gestión Header</a>';
				echo '</button>';
				echo '</section>';
			}
		?>
