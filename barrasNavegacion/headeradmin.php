...
<header>
		...
		<?php
			if (intval($_SESSION['id_rol']) === 2) {
				...
				echo '<a class="logoutbutton" href="' . $base . 'Vistadmin/gestion_header.php" class="gestion-header-button"><i class="fa-solid fa-screwdriver-wrench"></i>Gestión de Header</a>';
				echo '<a class="logoutbutton" href="' . $base . 'Vistadmin/panelusuarias.php" class="gestion-header-button"><i class="fa-solid fa-users-gear"></i></i>Gestión de Usuarias</a>';
			}
		?>
